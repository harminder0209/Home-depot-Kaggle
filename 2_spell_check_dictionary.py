...
def spell_check(text, spell_check_dict=spell_check_dict):
...
df_train = pd.read_csv("C:\\Users\\Minal\\Desktop\\Harry\\dataset\\train.csv", encoding="ISO-8859-1")
df_test = pd.read_csv("C:\\Users\\Minal\\Desktop\\Harry\\dataset\\test.csv",encoding="ISO-8859-1")



#correcting spelling of search term in test and train data set
df_test['search_term'] = df_test['search_term'].map(lambda x:spell_check(x))
df_train['search_term'] = df_train['search_term'].map(lambda x:spell_check(x))


#saving file
df_test.to_csv("C:\\Users\\Minal\\Desktop\\Harry\\dataset\\test_spellcheck.csv")
df_train.to_csv("C:\\Users\\Minal\\Desktop\\Harry\\dataset\\train_spellcheck.csv")
